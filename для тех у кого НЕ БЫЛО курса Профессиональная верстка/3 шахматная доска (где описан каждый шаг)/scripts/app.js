let app = {
    ...
    run() {
        //генерируем доску
        let board = this.generateBoard(); // сделано
        //добавляем доску в body
        document.body.innerHTML = board;

        //помещаем на доску все фигуры кроме пешек
        this.insertFiguresOnDesk(); // сделано
        //добавляем пешки
        this.insertPawns(); // сделано
        //добавляем колонку с номерами строк
        this.insertRowsNumbers(); // сделано
        //добавляем строку с названиями колонок
        this.insertColsChars(); // сделано
    },
    ...
    getFigure(name, colorClass) { // сделано
    ...
    generateRow(startWithColor, rowNum) { // сделано
    ...
    */
    ...
    generateField(color, rowNum, colChar) { // сделано
